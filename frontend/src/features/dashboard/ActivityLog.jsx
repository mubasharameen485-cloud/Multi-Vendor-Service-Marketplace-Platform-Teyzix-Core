  ...
  return (
    <div className="mt-8 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border dark:border-gray-700 transition-colors duration-300">
      ...
      <div className="space-y-4 max-h-64 overflow-y-auto pr-2">
        {logs.length === 0 ? (
          <p className="text-gray-500 dark:text-gray-400 italic text-sm">No recent activity.</p>
        ) : (
          logs.map((log) => (
            <div key={log._id} className="flex flex-col border-b dark:border-gray-700 pb-2">
